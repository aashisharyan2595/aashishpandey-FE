export default function AboutVisual() {
  return (
    ...
    >
      ...
      <rect width="300" height="360" rx="24" fill="none" stroke="var(--foreground)" strokeOpacity="0.08" />

      <circle className="av-glow" cx="150" cy="150" r="90" fill="var(--accent)" opacity="0.18" filter="url(#about-blur)" />
      ...
      <g className="av-orbit-outer">
        <circle cx="204" cy="112" r="3" fill="var(--foreground)" opacity="0.6" />
      </g>
      <g className="av-orbit-inner">
        <circle cx="90" cy="220" r="2.5" fill="var(--foreground)" opacity="0.4" />
      </g>

      <circle className="av-center" cx="150" cy="160" r="4" fill="var(--accent)" />

      <g fontFamily="var(--font-mono)" fontSize="10" fill="var(--muted)" letterSpacing="2">
