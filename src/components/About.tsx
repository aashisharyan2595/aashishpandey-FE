    ...
    <section id="about" className="px-6 py-32 md:px-12">
      <div className="grid gap-12 md:grid-cols-[1.4fr_1fr] md:items-center md:gap-16">
        <Reveal>
          ...
          <h2 className="font-display mt-4 max-w-3xl text-3xl leading-tight md:text-5xl">
        ...
        <Reveal delay={0.1} className="aspect-[5/6] w-full max-w-xs justify-self-center md:justify-self-end">
          <AboutVisual />
        </Reveal>
      </div>
